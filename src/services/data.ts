...
export const ItemDetailSchema = z.object({
	...
	alchemyDetail: z.object({
		bulkMultiplier: z.number(),
		isCoinifiable: z.boolean(),
		decomposeItems: z.array(ItemCountSchema).nullable(),
		transmuteSuccessRate: z.number(),
		transmuteDropTable: z.array(DropTableEntrySchema).nullable(),
	}).optional(),
